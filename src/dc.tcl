...
#Saving sdc
write_sdc ../outputs/fft_chip_clk_with_driving.sdc
...
###YBR
write -format verilog -hier -out ../outputs/fft_chip_clk_with_driving.v
write -format ddc -hier -out ../outputs/fft_chip_clk_with_driving.ddc
